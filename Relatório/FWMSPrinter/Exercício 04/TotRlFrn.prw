...
/*/{Protheus.doc} User Function TotRlFrn
    Lista 11 - FWMSPrinter | Exercício 04
    @type  Function
...
Static Function MontaRel(cAlias)
    ...
    Local cArquivo := 'Relatório Exer. 04 - Pedido de Compra com Totalizador.pdf'
