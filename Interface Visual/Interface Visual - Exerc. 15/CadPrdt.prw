...
/*/{Protheus.doc} User Function CadstPrdt
    Lista 04 - Interfaces Visuais | Exercício 15
    @type  Function
    @author André Lucas 
    @since 06/04/2023
    @version 0.1
...
Static Function ProcuPrdt()
    ...
    if lFlag
        ...
        if FWAlertYesNo(' Deseja cadastrar este código? ', 'CADASTRAR')
            AxCadastro('SB1', 'Cadastro de Produtos', .F., NIL)
        else
            FwAlertInfo('<b>Cadastro recusado.</b>')
        endif
    endif
